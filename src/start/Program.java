...
public class Program {
       ...
       public static void main(String[] args) {
            ...
            System.out.println(date3.compareDate(date3)+" "+date3.compareDate(date1)+ " "+ date1.compareDate(date3));
            MyDate[] arr= {new MyDate(1,2,2022),new MyDate(2,3,2022),new MyDate(12,8,2020), new MyDate(4,3,2022),new MyDate(3,3,2022),new MyDate(14,12,2021)};
            ...
            System.out.println("average temperature is: " + (int) arr2[Utility.getMaxTemp(arr2)].getAverage() + (char) 176 + "C");
            System.out.print("max temperature of " + arr2[1].getName() + ": ");
            arr2[1].getMax().printTempFull();
            System.out.println("\ntemperatures close to average: " + (int) arr2[1].getAverage() + (char) 176 + "C");
            arr2[1].printLocation(2);

           Swimmable[] arr3= {new Fish(20, 0, 0, 0, 0, 6),new Jellyfish(10, 0, 0, 0, 0, 8), new UnusualFish(15, 0, 0, 0, 0, 9,2),new MultiColorFish(20, 0, 0, 0, 0, 2), new Fish(18, 0, 0, 0, 0, 4),new Jellyfish(34, 0, 0, 0, 0, 7)};
